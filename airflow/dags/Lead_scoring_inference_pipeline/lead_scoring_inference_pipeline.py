...
constants = module_from_file("constants", "/Sairflow/dags/Lead_scoring_inference_pipeline/constants.py")
# /home/airflow/dags/Lead_scoring_inference_pipeline/utils.py
###############################################################################
